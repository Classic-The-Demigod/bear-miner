...
export default function BMTPurchase() {
  ...
  const percentRaised = 75.1;
  // const softcapTarget = 60000000;
  const participants = 335;
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-lg">
              Join the Bear Miner revolution. Secure your $BMT tokens at the
              lowest price before launch.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground bg-primary/5 p-4 rounded-xl border border-primary/10">
            ...
            <p>
              Tokens are automatically reserved and will be airdropped to your
              wallet at TGE (Token Generation Event).
            </p>
          </div>
        </div>
        ...
        <Card className="border-none shadow-2xl bg-gradient-to-b from-card to-background ring-1 ring-border/50 overflow-hidden relative">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-medium">
                ...
                <span className="text-muted-foreground">
                  1 SOL = {BMT_PER_SOL.toLocaleString()} BMT
                </span>
              </div>
              <div className="relative">
                <Input
                  ...
                  <>
                    ...
                    <div className="bg-muted/50 p-4 rounded-xl space-y-3 my-4 border">
                      ...
                      <div className="flex items-center gap-2 text-xs text-orange-500 bg-orange-500/10 p-2 rounded">
                        ...
                        Important: Buy directly from Phantom, Solflare, or
                    ...
                    <AlertDialogFooter className="mt-4">
                      ...
                      <Button
                        className="bg-primary text-[#F4D2AF] hover:bg-primary/90"
                ...
                {step === "success" && (
                  <div className="py-8 flex flex-col items-center justify-center text-center space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Your wallet transfer was confirmed. Your BMT allocation
                        will be tied to the connected wallet for TGE
                        distribution.
                      </p>
          ...
          <CardFooter className="bg-muted/30 p-4 text-center">
            <p className="text-xs text-muted-foreground w-full">
              By purchasing, you agree to our Terms of Service and Token Sale
              Policy.
            </p>
          </CardFooter>
        </Card>
