      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <Section title="Introduction">
          <Paragraph>
            ...
            fixed 2% daily return on deposited capital, paired with a 5%
          ...
          <Paragraph>
            The 2% daily return is the foundation of the protocol's economic
        ...
        <Section title="Market Problem & Opportunity">
          ...
          <Paragraph>
            ...
            behavioral constraints. The 2% daily return is not a marketing
        ...
        <Section title="Daily 2% Yield Mechanics">
          ...
          <Paragraph>
            The 2% daily return is the foundation of Bear Miner's economic model
          ...
          <Subheading>Why 2%?</Subheading>
          <Paragraph>
            The selection of a 2% daily return represents a balance between
            attractiveness and sustainability. Rates significantly higher than
            2% have historically led to rapid contract depletion, especially
            when combined with aggressive referral systems. Lower rates, while
            safer, often fail to sustain user engagement. At 2% daily, Bear
          ...
          <Paragraph>
            ...
            rewards do not count toward the 2% daily yield cap. Referral income
        ...
        <Section title="How Bear Miner Works">
          ...
          <Paragraph>
            ...
            a fixed 2% daily reward on their staked amount.
          </Paragraph>
        ...
        <Section title="Risk Framework & Investor Protection">
          ...
          <Paragraph>
            The fixed 2% daily yield introduces a clear risk-reward profile.
        ...
        <Section title="Governance, Roadmap & Long-Term Vision">
          ...
          <Paragraph>
            Core yield mechanics, including the 2% daily cap, are intended to
        ...
        <Section title="Final Conclusion">
          <Paragraph>
            ...
            model of decentralized yield generation. By combining a fixed 2%
